window.addEventListener("DOMContentLoaded", () => {
    ...
    Promise.all([
        fetch('/components/step-select.html').then(res => res.text()),
        fetch('/components/step-details.html').then(res => res.text()),
        fetch('/components/step-privacy.html').then(res => res.text()),
        fetch('/components/step-review.html').then(res => res.text()),
        fetch('/components/step-progress.html').then(res => res.text())
